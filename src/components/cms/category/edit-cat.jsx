...
import brandSvc from "./cat.service"
...
const EditCategory = () => {
    ...
    const submitEvent = async (data) => {
        try {
            ...
            const status = await CatSvc.update(payload, params.id)
    ...
    const getcatDetail = async () => {
        try {
            setLoading(true)
            const response = await CatSvc.getDataById(params.id)
            ...
            <div className="container-fluid px-4">
                ...
                <AdminBreadCrumb
                    ...
                    breadCrumbData={[
                        ...
                        { label: "Listbrand", url: "/admin/category" },
